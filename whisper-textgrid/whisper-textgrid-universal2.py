...
# Ici se produit une erreur si le script n'est pas dans le meme dossier que le son. Il faudrait récupérer le chemin d'exécution du script plutôt que celui du son. Ou alors exécuter le script dans le répertoire du son (pas idéal)
